      ...
      <div className="main_container">
        ...
        <div className="top_datas">
          ...
          <div className="data_third_box">
            ...
            <img className="img_fluid" src="/assets/images/vector.png" alt="" />
          </div>
        </div>
          ...
          <div className="radio_group">
            ...
            <label className="label_space">
              <input
                ...
                value="active"
                name="none"
                onClick={() => filterSensorLogsMode("Active")}
              />
              Active
              <span></span>
            </label>
            <label className="label_space">
              <input
                ...
                value="active"
                name="none"
                onClick={() => filterSensorLogsMode("InActive")}
              />
              Inactive
              <span></span>
            </label>
